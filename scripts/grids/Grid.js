class Grid {
    ...
    drawGrid() {
        ...
        for (let i = -size; i <= size; i += this.bigGridSize) {
            DRAW_MANAGER.batchLine(new Line(new Vector2(-size * this.gridSize, i * this.gridSize), new Vector2(size * this.gridSize, i * this.gridSize)), true);
            DRAW_MANAGER.batchLine(new Line(new Vector2(i * this.gridSize, -size * this.gridSize), new Vector2(i * this.gridSize, size * this.gridSize)), true);
        }
